...
namespace Unit.Tests
{
    ...
    public partial class InterfaceInterceptorFixture
    {
        ...
        {
            IInstanceInterceptor interceptor = new Unity.Interception.Interceptors.InstanceInterceptors.InterfaceInterception.InterfaceInterceptor();
        ...
        public void CanInterceptDerivedInterface()
        {
            ...
            container.AddNewExtension<Interception>()
                .Configure<Interception>()
                    .SetDefaultInterceptorFor<IOrderService>(new Unity.Interception.Interceptors.InstanceInterceptors.InterfaceInterception.InterfaceInterceptor());
        ...
        public void InterfaceInterceptorSetsTargetToTargetObject()
        {
            ...
            var proxy = Intercept.ThroughProxy<IInterfaceOne>(
                actualTarget, new Unity.Interception.Interceptors.InstanceInterceptors.InterfaceInterception.InterfaceInterceptor(),
                new[] { behavior });
        ...
        public void CanInterceptInterfaceWithGenericMethod()
        {
            ...
            var proxy = Intercept.ThroughProxy<IInterfaceWithGenericMethod>(
                target, new Unity.Interception.Interceptors.InstanceInterceptors.InterfaceInterception.InterfaceInterceptor(),
                new[] { behavior });
        ...
        public void CanInterceptNonGenericMethodOnNonGenericInterface()
        {
            ...
            var proxy =
                Intercept.ThroughProxy<INonGenericInterface>(
                    target,
                    new Unity.Interception.Interceptors.InstanceInterceptors.InterfaceInterception.InterfaceInterceptor(),
                    new[] { behavior });
...
#pragma warning restore IDE0059 // Unnecessary assignment of a value
        ...
        public void InterceptorCorrectlyRethrowsException()
        {
            IUnityContainer container = new UnityContainer()
                ...
                .Configure<Interception>()
                    .SetInterceptorFor(typeof(IFoo), new Unity.Interception.Interceptors.InstanceInterceptors.InterfaceInterception.InterfaceInterceptor())
