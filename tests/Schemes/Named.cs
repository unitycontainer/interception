...
namespace Storage
{
    public partial class Schemes
    {
        ...
        [PatternTestMethod(NAMED_PATTERN), TestProperty(INTERFACE, NAMED)]
        [ExpectedException(typeof(NullReferenceException))]
        public void Set_null_null_null_instance()
        {
            // Act
            SchemeStorage.Set(null, null, null, Instance);
        }


        [PatternTestMethod(NAMED_PATTERN), TestProperty(INTERFACE, NAMED)]
        [ExpectedException(typeof(NullReferenceException))]
        public void Set_target_null_null_instance()
        {
            // Act
        ...
        [PatternTestMethod(NAMED_PATTERN), TestProperty(INTERFACE, NAMED)]
        public void Set_null_null_type_instance()
        {
            // Act
            SchemeStorage.Set(null, null, typeof(object), Instance);
        ...
        [PatternTestMethod(NAMED_PATTERN), TestProperty(INTERFACE, NAMED)]
        public void Set_null_Name_type_instance()
        {
            // Act
            SchemeStorage.Set(null, Name, typeof(object), Instance);
        ...
        [PatternTestMethod(NAMED_PATTERN), TestProperty(INTERFACE, NAMED)]
        public void Set_target_Name_type_replace()
        {

            // Act
            SchemeStorage.Set(typeof(object), Name, typeof(object), Instance);
            SchemeStorage.Set(typeof(object), Name, typeof(object), Other);
        ...
        [PatternTestMethod(NAMED_PATTERN), TestProperty(INTERFACE, NAMED)]
        public void Set_target_Name_type_list2set()
        {

            // Act
            SchemeStorage.Set(typeof(object), null, typeof(object), Instance);
            SchemeStorage.Set(typeof(object), Name, typeof(object), Other);
            ...
            Assert.AreSame(Instance, entry[0]);
            Assert.AreSame(Other,    entry[1]);
            Assert.IsNull(Other.Next);
            Assert.IsNull(Instance.Next);
        }


        [PatternTestMethod(NAMED_PATTERN), TestProperty(INTERFACE, NAMED)]
        public void Set_target_overload_type_instance()
        {
            // Act
            foreach (var type in TestTypes.Take(100))
            {
                SchemeStorage.Set(typeof(string), type.Name, typeof(object), Instance);
            }

            // Validate
            var entry = SchemeStorage.ToArray();

            Assert.AreEqual(100, entry.Length);
            Assert.IsNull(Instance.Next);
        }


        [PatternTestMethod(NAMED_PATTERN), TestProperty(INTERFACE, NAMED)]
        public void Set_target_overload_type_twice()
        {
            // Act
            foreach (var type in TestTypes.Take(100))
            {
